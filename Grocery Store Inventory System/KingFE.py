...
def open_new_window():
    ...
    if not username or not password:
        ...
        new_window_in = tk.Button(open_window, text="IN", font=("Times New Roman", 40, "bold"), bg="#00CED1", fg= "White", command=window_IN, width= 15, borderwidth= 5)
        new_window_in.pack(pady = 50)
        
        new_window_inventory = tk.Button(open_window, text="INVENTORY", font=("Times New Roman", 40, "bold"), bg="#00CED1",fg= "White", width= 15, borderwidth= 5, command=window_INVENTORY)
        new_window_inventory.pack(pady= 50)
        
        new_window_out = tk.Button(open_window, text="OUT", font=("Times New Roman", 40, "bold"), bg="#00CED1", fg= "White", width= 15 , borderwidth= 5, command=window_OUT)
...
log_in_text = tk.Label(root, text="Log In", font=("Times", 80, "bold"), fg="white", bg="#0F0E42")
...
username_label = tk.Label(root, text="Username", font=("Roboto", 30), fg="white", bg="#18185E")
username_label.pack(pady=20)
username_entry = tk.Entry(root, textvariable=User_Entry, font=("Arial", 14), width=30, borderwidth=5)
username_entry.pack(pady=10)


password_label = tk.Label(root, text="Password", font=("Roboto", 30), fg="white", bg="#202379")
